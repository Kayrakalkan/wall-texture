...
var Image = class _Image extends Control {
  ...
  set source(value) {
    ...
    if (imgElement.style) {
      ...
      (_d = (_c = engine.getRenderingCanvas()) == null ? void 0 : _c.parentNode) == null ? void 0 : _d.appendChild(imgElement);
    }
    if (value) {
